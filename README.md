...
#### Arcade.old.py
The Prototype engine, works with global variables and functions, is effective but hard to work in if implementing a new game. The mainloops are messy and confusing, and the sprite implementation is hard to do